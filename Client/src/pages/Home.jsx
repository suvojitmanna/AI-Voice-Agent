    ...
    >
      ...
      <section className="relative overflow-hidden px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20 lg:pt-24 pb-20 z-10">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="text-center mt-10 sm:mt-12">
            ...
            {/* Premium Scroll Reveal Stage for AssistantPreview */}
            <motion.div
      ...
      <section className="relative py-16 overflow-hidden z-10">
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          {/* Heading Section: Now reveals elegantly on scroll every time */}
          <motion.div
          ...
          {/* Cards Grid: Re-triggers execution on scroll every time */}
          <motion.div
          ...
          >
            {STEPS.map((item, index) => (
              ...
              >
                {/* Active Dynamic Border Gradient Glow */}
                <AnimatePresence>
                  {hoveredCard === index && (
                    <motion.div
                      layoutId="activeGlow"
                ...
                <div className="relative p-8 z-10 flex flex-col h-full justify-between">
                  <div>
                    <div className="flex justify-between items-center">
                      {/* Number node coordinates with parent view trigger */}
                      <motion.div
                        initial={{ scale: 0 }}
                        whileInView={{ scale: 1 }}
                        viewport={{ once: false }}
