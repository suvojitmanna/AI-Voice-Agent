...
// Advanced Easing Curve (Apple/Premium Style Archetype)
  ...
  <script src="${ClientUrl}/assistant.js" data-user-id="${user?._id}"></script>
            ...
            <div className="relative">
              ...
              <motion.button
                ...
                disabled={copied}
                className="absolute top-4 right-4 w-10 h-10 rounded-xl bg-white dark:bg-slate-800 shadow-sm flex items-center justify-center cursor-pointer border border-gray-100 dark:border-slate-700"
              >
                {copied ? (
                  <FiCheck className="text-emerald-500 w-5 h-5" />
                ) : (
                  <FiCopy className="text-slate-600 dark:text-slate-300 w-5 h-5" />
                )}
              </motion.button>
            </div>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-xs font-medium text-gray-400 dark:text-gray-500 mt-2.5 leading-5 opacity-80">
                Encrypted at rest securely. Only referenced server-side during
                generation context routines.
              </p>
            </motion.div>
            ...
            >
              ...
              {/* Added Page List wrapped in dynamic layouts */}
            ...
            <motion.button
              ...
              className={`flex items-center justify-center gap-2.5 w-full h-12 rounded-2xl bg-gradient-to-r from-purple-500 to-emerald-500 text-white font-semibold shadow-md ${
                isSaveDisabled
                  ? "bg-gray-200 dark:bg-gray-800 text-gray-400 dark:text-gray-600 cursor-not-allowed select-none shadow-none cursor: not-allowed;"
